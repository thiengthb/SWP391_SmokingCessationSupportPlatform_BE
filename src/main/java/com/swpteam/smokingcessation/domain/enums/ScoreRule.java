...
public enum ScoreRule {
    ...
    NO_SMOKING_FOR_10DAYS(100, "10 days nonsmoke"),
    NO_SMOKING_FOR_30DAYS(500, "30 days nonsmoke"),
    NO_SMOKING_FOR_180DAYS(1000, "180 days nonsmoke"),
    NO_SMOKING_FOR_365DAYS(3000, "365 days nonsmoke");
